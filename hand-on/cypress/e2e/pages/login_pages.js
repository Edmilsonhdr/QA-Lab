...
class LoginPage {
  accessHomePage() {
    cy.visit(url);
    cy.wait(3000); // Ajuste esse tempo conforme necessário para sua aplicação
  ...
  fillLoginInfo(email, password) {
    ...
    cy.get(loginElements.inputPassword()).type(password); // Note os parênteses no inputPassword
  }
